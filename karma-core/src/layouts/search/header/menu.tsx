  ...
  return (
    <div className={classes.menu}>
      ...
      {!givenNameInitial && !mobile && (
        <React.Fragment>
          ...
          <Button
            color="inherit"
            variant="outlined"
            onClick={handleClick(`${protocal}auth.${domain}/sign-up`, true)}
          >
            Sign Up
          </Button>
        </React.Fragment>
      ...
      <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleClose}>
        {!givenNameInitial && (
          <React.Fragment>
            <MenuItem onClick={handleClick(`${protocal}${domain}/contact`, true)}>
              Post Job
            </MenuItem>
            <MenuItem onClick={handleClick(`${protocal}auth.${domain}`, true)}>Login</MenuItem>
            <MenuItem onClick={handleClick(`${protocal}auth.${domain}/sign-up`, true)}>Sign Up</MenuItem>
          </React.Fragment>
        )}
        {givenNameInitial && (
          <React.Fragment>
